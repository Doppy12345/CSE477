...
def create_app(debug=False):
	...
	db.prepopulateTables("institutions.csv")
	db.prepopulateTables("positions.csv")
	db.prepopulateTables("experiences.csv")
	db.prepopulateTables("skills.csv")
	db.prepopulateTables("exp_skills.csv")
