# [Web Application Development](https://gitlab.msu.edu/cse477-fall-2022/course-materials/): Homework 3
...
```bash
git pull https://gitlab.msu.edu/cse477-fall-2022/course-materials.git
```
...
```bash
gcloud builds submit --tag gcr.io/cse477-fall-2022/homework
gcloud run deploy --image gcr.io/cse477-fall-2022/homework --platform managed
```
...
```bash
Deploying container to Cloud Run service [homework] in project [cse477-fall-2022] region [us-central1]
...
[Submit the Service URL for your live web application in this Google Form](https://docs.google.com/forms/d/e/1FAIpQLSdbIo4FiIx_MyjTYD0er16ATMFwSs6eAgbCKZ68J6X-bOrCXQ/viewform). 
